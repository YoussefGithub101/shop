...
export class ShopComponent implements OnInit {
  ...
  constructor(private t: Title, private elementRef: ElementRef, private renderer: Renderer2, private ProductsService: ProductsService, private activatedRoute: ActivatedRoute, public router: Router, private http: HttpClient, private CartService: CartService) {
